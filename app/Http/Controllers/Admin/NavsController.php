...
//        $validator = Validator::make($input,$rules,$messages);
        if ($validator->passes()){
            ...
            if($re){
                ...
                return back()->with('errors','导航添加失败,稍后重试!');
            }
        }
        else{
    ...
    //get.admin/category/{category}/edit 编辑导航
    ...
    //put.admin/category/{category} 更新导航
