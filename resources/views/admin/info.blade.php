...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/category/create')}}"><i class="fa fa-refresh"></i>新增分类</a>
                <a href="{{url('admin/article/create')}}"><i class="fa fa-plus"></i>新增文章</a>
                <a href="{{url('admin/links/create')}}"><i class="fa fa-recycle"></i>新增链接</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
    ...
    <div class="result_wrap">
        <div class="resulet_title">
            <h3>使用帮助</h3>
        </div>
        <div class="result_content">
            <ul>
                <li>
                    <label>交流网站:</label><span><a href="#" >http://www.ainightfool.com/</a></span>
                </li>
            </ul>
        </div>
